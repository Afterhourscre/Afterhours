...
define([
    ...
    $.widget('mageworx.optionFeatures', {
        ...
        applyChanges: function (base, productConfig) {
            ...
            var finalPriceInclTax = base.calculateSelectedOptionsPrice(true, false),
                finalPriceExclTax = base.calculateSelectedOptionsPrice(false, false),
                regularPriceInclTax = base.calculateSelectedOptionsPrice(true, true),
                regularPriceExclTax = base.calculateSelectedOptionsPrice(false, true);

            if (!isAbsolutePriceUsed || (isAbsolutePriceUsed && finalPriceExclTax <= 0)) {
                regularPriceExclTax = parseFloat(productConfig.regular_price_excl_tax) + parseFloat(regularPriceExclTax);
                regularPriceInclTax = parseFloat(productConfig.regular_price_incl_tax) + parseFloat(regularPriceInclTax);
                finalPriceExclTax = parseFloat(productConfig.final_price_excl_tax) + parseFloat(finalPriceExclTax);
