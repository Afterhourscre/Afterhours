...
namespace Aheadworks\Faq\Test\Unit\Model\ResourceModel\Category\Grid;

use Aheadworks\Faq\Model\ResourceModel\Category\Grid\Collection;
...
class CollectionTest extends TestCase
{
     ...
     */
    const MAIN_TABLE = 'category_table';
