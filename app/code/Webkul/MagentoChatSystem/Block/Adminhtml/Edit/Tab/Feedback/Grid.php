    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'align' => 'center',
                //'filter' => \Webkul\MagentoChatSystem\Block\Adminhtml\Edit\Tab\Feedback\Grid\Filter\Rating::class,
                'index' => 'rating',
                //'renderer' => \Webkul\MagentoChatSystem\Block\Adminhtml\Edit\Tab\Feedback\Grid\Renderer\Rating::class
            ]
        );
        $this->addColumn(
            'status',
