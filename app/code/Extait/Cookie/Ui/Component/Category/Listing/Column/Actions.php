...
namespace Extait\Cookie\Ui\Component\Category\Listing\Column;
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                $category = $categoryCollection->getItemById($item[CategoryInterface::ID]);

                $item[$this->getData('name')]['delete'] = [
                    'href' => $this->urlBuilder->getUrl('cookie/category/edit', ['id' => $category->getId()]),
                    'label' => __('Edit'),
                    'hidden' => false,
                ];
            }
