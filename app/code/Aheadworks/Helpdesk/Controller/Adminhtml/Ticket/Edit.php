...
class Edit extends \Aheadworks\Helpdesk\Controller\Adminhtml\Ticket
{
    ...
    public function execute()
    {
        ...
        $adminUser = $this->userFactory->create()->load($ticketModel->getAgentId());
        if ($ticketModel->getAgentId() && !$adminUser->getIsActive()) {
            $this->messageManager->addWarningMessage(__('This ticket is assigned to inactive agent.'));
        }
