...
class Upload extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        try {
            ...
            if (strtolower($message) === strtolower('$_FILES array is empty')) {
                $message = __('This file cannot be attached (too large file or forbidden type).');
            }
            $result = ['error' => $message, 'errorcode' => $e->getCode()];
        }
