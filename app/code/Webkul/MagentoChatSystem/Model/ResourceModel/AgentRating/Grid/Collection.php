...
namespace Webkul\MagentoChatSystem\Model\ResourceModel\AgentRating\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Webkul\MagentoChatSystem\Model\ResourceModel\AgentRating\Collection as AgentRatingCollection;

/**
 * Class Collection
 * Collection for displaying grid of assigned chat
 */
class Collection extends AgentRatingCollection implements SearchResultInterface
{
    /**
    ...
    protected function _initSelect()
    {
        ...
        $agentGridFlat = $this->getTable('chatsystem_agentdata');
        ...
        $this->getSelect()->join(
            $agentGridFlat.' as agf',
            'main_table.agent_id = agf.agent_id',
