...
use Aheadworks\Helpdesk\Model\Automation;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $conditionFormHtml = $this->getLayout()->createBlock(
            \Aheadworks\Helpdesk\Block\Adminhtml\Automation\Edit\Renderer\Conditions::class
        )
        ...
        $fieldset->addField(
            'conditions',
            \Aheadworks\Helpdesk\Block\Adminhtml\Automation\Edit\Form\Element\Template::class,
            [
                'name' => 'conditions',
        ...
        $addConditionHtml = $this->getLayout()->createBlock(
            ...
            ->setItemsCount(count((array)$model->getConditions()))
            ->toHtml();
        ...
        $actionFormHtml = $this->getLayout()->createBlock(
            \Aheadworks\Helpdesk\Block\Adminhtml\Automation\Edit\Renderer\Actions::class
        )
        ...
        $addActionHtml = $this->getLayout()->createBlock(
            ...
            ->setItemsCount(count((array)$model->getActions()))
            ->toHtml();
