...
use Webkul\MagentoChatSystem\Model\ResourceModel\TotalAssignedChat as ResourceTotalAssignedChat;
...
class TotalAssignedChat extends AbstractModel implements TotalAssignedChatInterface, IdentityInterface
{
    ...
    {
        $this->_init('Webkul\MagentoChatSystem\Model\ResourceModel\TotalAssignedChat');
    }
