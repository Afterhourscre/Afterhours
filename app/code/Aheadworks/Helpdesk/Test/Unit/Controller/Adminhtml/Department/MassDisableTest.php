...
use Aheadworks\Helpdesk\Controller\Adminhtml\Department\MassDisable;
...
/**
 * Test for \Aheadworks\Helpdesk\Controller\Adminhtml\Department\MassDisable
...
class MassDisableTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecute()
    {
        ...
        $departmentDataObjectMock->expects($this->exactly(2))
            ->method('getId')
            ->willReturn($departmentId);
        ...
        $this->messageManagerMock->expects($this->once())
            ...
            ->with(__('A total of %1 department(s) have been disabled', $count))
            ->willReturnSelf();
    ...
    public function testExecuteErrorOccurs()
    {
        ...
        $this->messageManagerMock->expects($this->once())
            ...
            ->with(__('Something went wrong while disabling department(s)'))
            ->willReturnSelf();
