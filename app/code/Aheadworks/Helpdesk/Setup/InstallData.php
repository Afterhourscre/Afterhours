    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $setup->getConnection()->insertForce(
            ...
            [
                ...
                'conditions' => $this->serializer->serialize($newCustomerTicketConditions),
                'actions' => $this->serializer->serialize($newCustomerTicketActions),
            ]
        );
        ...
        $setup->getConnection()->insertForce(
            ...
            [
                ...
                'conditions' => $this->serializer->serialize($newAgentTicketConditions),
                'actions' => $this->serializer->serialize($newAgentTicketActions),
            ]
        );
        ...
        $setup->getConnection()->insertForce(
            ...
            [
                ...
                'conditions' => $this->serializer->serialize($newCustomerReplyConditions),
                'actions' => $this->serializer->serialize($newCustomerReplyActions),
            ]
        );
        ...
        $setup->getConnection()->insertForce(
            ...
            [
                ...
                'conditions' => $this->serializer->serialize($newAgentReplyConditions),
                'actions' => $this->serializer->serialize($newAgentReplyActions),
            ]
        );
        ...
        $setup->getConnection()->insertForce(
            ...
            [
                ...
                'conditions' => $this->serializer->serialize($ticketAssignedConditions),
                'actions' => $this->serializer->serialize($ticketAssignedActions),
            ]
        );
        ...
        $setup->getConnection()->insertForce(
            ...
            [
                ...
                'conditions' => $this->serializer->serialize($waitingTicketConditions),
                'actions' => $this->serializer->serialize($waitingTicketActions),
            ]
        );
        ...
        $setup->getConnection()->insertForce(
            ...
            [
                ...
                'priority' => 0,
                'event' => \Aheadworks\Helpdesk\Model\Source\Automation\Event::RECURRING_TASK_VALUE,
                'conditions' => $this->serializer->serialize($leftMessagesConditions),
                'actions' => $this->serializer->serialize($leftMessagesActions),
            ]
        );
        ...
        $setup->getConnection()->insertForce(
            ...
            [
                ...
                'priority' => 0,
                'event' => \Aheadworks\Helpdesk\Model\Source\Automation\Event::RECURRING_TASK_VALUE,
                'conditions' => $this->serializer->serialize($followupConditions),
                'actions' => $this->serializer->serialize($followupActions),
            ]
        );
        $setup->endSetup();
    }
