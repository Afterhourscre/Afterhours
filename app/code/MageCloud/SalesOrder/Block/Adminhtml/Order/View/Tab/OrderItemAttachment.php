...
namespace MageCloud\SalesOrder\Block\Adminhtml\Order\View\Tab;

use Magento\Backend\Block\Template\Context;
use Magento\Sales\Model\AdminOrder\Create  as OrderCreate;

class OrderItemAttachment extends \Magento\Sales\Block\Adminhtml\Order\AbstractOrder implements
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        return __('Order Item Attachments');
    }
