...
define([
    ...
    $.widget("awhelpdesk.awHelpdeskFileUpload", {
        itemsCount: 0,
        itemIndex: 0,
        linkTitle: '',
        options: {
        ...
        _create: function() {
            ...
            this.element.fileupload({
                ...
                start: this.spinningWheelStart,
                stop: this.spinningWheelEnd
            });
            this._bind();
        },
        destroy: function() {
        ...
        spinningWheelStart: function() {
            $("body").trigger('processStart');
        },
        spinningWheelEnd: function() {
            $("body").trigger('processStop');
        }
    });

    return $.awhelpdesk.awHelpdeskFileUpload;
});