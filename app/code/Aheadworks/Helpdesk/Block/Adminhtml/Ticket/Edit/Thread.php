...
use Aheadworks\Helpdesk\Model\QuickResponse\Provider;
...
class Thread extends \Magento\Backend\Block\Template
{
     ...
     * @var Provider
     */
    protected $quickResponseProvider;
     ...
     * @param Provider $quickResponseProvider
     * @param array $data
     */
    public function __construct(
        ...
        Provider $quickResponseProvider,
        array $data = []
    ) {
        ...
        $this->quickResponseProvider = $quickResponseProvider;
    ...
    {
        return json_encode($this->statusSource->getTranslatedOptionsArray());
    }
    ...
    public function getQuickResponseList()
    {
        ...
        return $this->quickResponseProvider->getQuickResponsesValues($ticket->getStoreId());
    }
}
