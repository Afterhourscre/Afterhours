...
namespace Aheadworks\OnSale\Block\Adminhtml\Page\Menu;

use Aheadworks\OnSale\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\OnSale\Block\Adminhtml\Page\Menu
 */
class Item extends Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_OnSale::page/menu/item.phtml';
