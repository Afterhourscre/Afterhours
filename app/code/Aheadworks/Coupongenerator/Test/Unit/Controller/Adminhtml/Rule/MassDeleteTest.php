...
use Aheadworks\Coupongenerator\Controller\Adminhtml\Rule\MassDelete;
...
/**
 * Test for \Aheadworks\Coupongenerator\Controller\Adminhtml\Rule\MassDelete
...
class MassDeleteTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecute()
    {
        ...
        $magentoRuleMock->expects($this->exactly(2))
            ->method('getRuleId')
            ->willReturn($magentoRuleId);
        ...
        $this->messageManagerMock->expects($this->once())
            ...
            ->with(__('A total of %1 rule(s) have been deleted', $count))
            ->willReturnSelf();
