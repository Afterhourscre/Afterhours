...
class CreateAutomation
{
     ...
     * @param \Aheadworks\Helpdesk\Model\ResourceModel\Automation\Recurring\CollectionFactory
     * $recurringCollectionFactory
    ...
    public function execute()
    {
        ...
        $this->automationResource->createAutomationAction(
            \Aheadworks\Helpdesk\Model\Source\Automation\Event::RECURRING_TASK_VALUE
        );
