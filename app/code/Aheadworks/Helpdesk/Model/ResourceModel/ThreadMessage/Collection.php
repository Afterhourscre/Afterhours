...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init(
            \Aheadworks\Helpdesk\Model\ThreadMessage::class,
            \Aheadworks\Helpdesk\Model\ResourceModel\ThreadMessage::class
        );
    }
    ...
    public function addNotInternalType()
    {
        return $this->addFilter(
            'type',
            ['neq' => \Aheadworks\Helpdesk\Model\ThreadMessage::OWNER_ADMIN_INTERNAL_VALUE],
            'public'
        );
    }
