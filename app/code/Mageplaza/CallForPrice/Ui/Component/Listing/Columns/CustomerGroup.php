...
namespace Mageplaza\CallForPrice\Ui\Component\Listing\Columns;
...
/**
 * Class CustomerGroup
 * @package Mageplaza\CallForPrice\Ui\Component\Listing\Columns
 */
    ...
    protected function _prepareItem(array $item, $customerGroup)
    {
        ...
        if (isset($item['customer_group_ids'])) {
            ...
            foreach ($groupIds as $groupId) {
                ...
                $content           .= ($lastItem != $groupId) ? $customerGroupCode . ', ' : $customerGroupCode;
            }
        }
