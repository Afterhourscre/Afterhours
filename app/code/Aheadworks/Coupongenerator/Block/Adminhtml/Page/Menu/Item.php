...
namespace Aheadworks\Coupongenerator\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\Coupongenerator\Block\Adminhtml\Page\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_Coupongenerator::page/menu/item.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->isCurrent()) {
            /** @var \Aheadworks\Coupongenerator\Block\Adminhtml\Page\Menu $menu */
