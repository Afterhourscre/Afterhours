...
namespace Aheadworks\Acr\Block\Adminhtml\Page\Menu;

use Aheadworks\Acr\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\Acr\Block\Adminhtml\Page\Menu
 * @codeCoverageIgnore
 */
class Item extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_Acr::page/menu/item.phtml';
