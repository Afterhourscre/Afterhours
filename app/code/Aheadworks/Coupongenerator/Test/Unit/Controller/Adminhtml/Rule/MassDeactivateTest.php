...
use Aheadworks\Coupongenerator\Controller\Adminhtml\Rule\MassDeactivate;
...
/**
 * Test for \Aheadworks\Coupongenerator\Controller\Adminhtml\Rule\MassDeactivate
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 */
class MassDeactivateTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var MassDeactivate
     */
    ...
    public function testExecute()
    {
        ...
        $this->messageManagerMock->expects($this->once())
            ...
            ->with(__('A total of %1 rule(s) have been deactivated', $count))
            ->willReturnSelf();
