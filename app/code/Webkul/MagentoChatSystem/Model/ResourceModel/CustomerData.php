...
class CustomerData extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('chatsystem_userdata', 'entity_id');
    }
    ...
    {
        return $this->_metadataPool->getMetadata(CustomerDataInterface::class)->getEntityConnection();
    }
     ...
     * @throws \Exception
     */
    private function getCustomerDataById(AbstractModel $object, $value, $field = null)
    {
        $entityMetadata = $this->_metadataPool->getMetadata(CustomerDataInterface::class);
    ...
    {
        $blockId = $this->getCustomerDataById($object, $value, $field);
        if ($blockId) {
