...
namespace Webkul\MagentoChatSystem\Model\ResourceModel\AssignedChat\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Webkul\MagentoChatSystem\Model\ResourceModel\AssignedChat\Collection as AssignedChatCollection;

/**
 * Class Collection
 * Collection for displaying grid of assigned chat
 */
class Collection extends AssignedChatCollection implements SearchResultInterface
{
    /**
    ...
    protected function _initSelect()
    {
        ...
        $agentGridFlat = $this->getTable('admin_user');
        ...
        $this->getSelect()->join(
            ...
            'main_table.agent_id = agf.user_id',
            ['agentname' => "firstname"]
        );
