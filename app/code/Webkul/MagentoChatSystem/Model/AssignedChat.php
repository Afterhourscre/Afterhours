...
use Webkul\MagentoChatSystem\Model\ResourceModel\AssignedChat as ResourceAssignedChat;
...
class AssignedChat extends AbstractModel implements AssignedChatInterface, IdentityInterface
{
    ...
    {
        $this->_init('Webkul\MagentoChatSystem\Model\ResourceModel\AssignedChat');
    }
