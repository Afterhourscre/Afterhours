<?php
namespace MageCloud\CurrencyConverter\Model\Currency\Import;
...
class Fcc extends \Magento\Directory\Model\Currency\Import\AbstractImport
{
     ...
     * @var string
     */
    const CURRENCY_CONVERTER_URL = 'https://free.currencyconverterapi.com/api/v3/convert?q={{CURRENCY_FROM}}_{{CURRENCY_TO}}&apiKey=010037e4fff06a19cec1';
    /**
     * HTTP client
     *
