    ...
    public function getMenuItems()
    {
        if ($this->items === null) {
            $items = [
                ...
                'quickresponse' => [
                    'title' => __('Quick Response'),
                    'url' => $this->getUrl('*/quickresponse/index'),
                    'resource' => 'Aheadworks_Helpdesk::quick_responses'
                ],
                'system_config' => [
                    'title' => __('Settings'),
                ...
                'readme' => [
                    'title' => __('Readme'),
                    'url' => 'https://aheadworks.atlassian.net/wiki/spaces/EUDOC/'
                        . 'pages/1224146947/Help+Desk+Ultimate+-+Magento+2',
                    'attr' => [
                        'target' => '_blank'
                    ],
                    'separator' => true
