...
class Message extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('chatsystem_history', 'entity_id');
    }
    ...
    {
        return $this->_metadataPool->getMetadata(MessageInterface::class)->getEntityConnection();
    }
     ...
     * @throws \Exception
     */
    private function getMessageById(AbstractModel $object, $value, $field = null)
    {
        $entityMetadata = $this->_metadataPool->getMetadata(MessageInterface::class);
    ...
    {
        $blockId = $this->getMessageById($object, $value, $field);
        if ($blockId) {
