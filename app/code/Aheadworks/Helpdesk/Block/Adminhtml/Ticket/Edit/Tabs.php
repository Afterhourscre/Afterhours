    ...
    protected function _construct()
    {
        ...
        $this->setTitle(
            htmlspecialchars_decode(
                __('Ticket [%s]', $ticketModel->getUid()) . " " . addslashes($ticketModel->getSubject())
            )
        );
    }
    ...
    protected function _prepareLayout()
    {
        $this->addTab(
            ...
            [
                ...
                'content' => $this->getLayout()->createBlock(
                    \Aheadworks\Helpdesk\Block\Adminhtml\Ticket\Edit\Tabs\General::class,
        ...
        $this->addTab(
            ...
            [
                'label' => $name,
                'content' => $this->getLayout()->createBlock(
                    \Aheadworks\Helpdesk\Block\Adminhtml\Ticket\Edit\Tabs\Customer::class,
        ...
        if (count($ticketList) > 0) {
            $this->addTab(
                ...
                [
                    'label' => __('Tickets'),
                    'content' => $this->getLayout()->createBlock(
                        \Aheadworks\Helpdesk\Block\Adminhtml\Ticket\Edit\Tabs\Ticket::class,
        ...
        if (count($orderList) > 0) {
            $this->addTab(
                ...
                [
                    'label' => __('Purchases'),
                    'content' => $this->getLayout()->createBlock(
                        \Aheadworks\Helpdesk\Block\Adminhtml\Ticket\Edit\Tabs\Purchases::class,
