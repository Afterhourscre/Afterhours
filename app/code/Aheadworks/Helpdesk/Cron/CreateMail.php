...
use Aheadworks\Helpdesk\Model\Gateway;
use Aheadworks\Helpdesk\Model\Mail\ThreadMessage\Filter;
use Aheadworks\Helpdesk\Model\ResourceModel\Mail;
use Aheadworks\Helpdesk\Model\MailFactory;
...
class CreateMail
{
    ...
    protected function getMessageBody($message)
    {
        ...
        return $this->filter->cutRepliesHistory($content);
    }
