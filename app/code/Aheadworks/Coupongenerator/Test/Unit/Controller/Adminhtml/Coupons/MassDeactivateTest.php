...
use Aheadworks\Coupongenerator\Controller\Adminhtml\Coupons\MassDeactivate;
...
/**
 * Test for \Aheadworks\Coupongenerator\Controller\Adminhtml\Coupons\MassDeactivate
...
class MassDeactivateTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testExecute()
    {
        ...
        $this->messageManagerMock->expects($this->once())
            ...
            ->with(__('A total of %1 coupon(s) have been deactivated', $count))
            ->willReturnSelf();
