...
namespace Aheadworks\Faq\Block\Adminhtml\Page\Menu;
...
class Item extends Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_Faq::page/menu/item.phtml';
    ...
    protected function _prepareLayout()
    {
        ...
        if ($this->isCurrent()) {
            /** @var \Aheadworks\Faq\Block\Adminhtml\Page\Menu $menu */
