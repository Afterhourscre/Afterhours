...
class TicketFlat extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function __construct(
        ...
        \Aheadworks\Helpdesk\Model\ResourceModel\ThreadMessage\CollectionFactory $threadMessageCollectionFactory,
    ...
    {
        $this->_init(\Aheadworks\Helpdesk\Model\ResourceModel\TicketFlat::class);
    }
    ...
    public function getDataModel()
    {
        ...
        $this->dataObjectHelper->populateWithArray(
            $ticketDataObject,
            $ticketData,
            \Aheadworks\Helpdesk\Api\Data\TicketFlatInterface::class
        );
