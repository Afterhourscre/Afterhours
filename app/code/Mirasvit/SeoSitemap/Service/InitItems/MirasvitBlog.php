...
class MirasvitBlog extends \Magento\Sitemap\Model\Sitemap implements SeoSitemapInitItemInterface
{
    ...
    public function initSitemapItem($storeId)
    {
        ...
        if ($this->moduleManager->isEnabled('Mirasvit_Blog')) {
            ...
            [
                ...
                'collection' => $this->getMirasvitBlogItems($storeId),
            ]);
        }
    ...
    private function getMirasvitBlogItems($storeId)
    {
